  ...
  return (
    <>
      <div className="flex items-center justify-center w-screen h-full">
        <div className="absolute top-1/2 left-[49.975%] z-10 hidden aspect-[0.54/1] h-full -translate-x-[50.025%] -translate-y-1/2  sm:block">
          <img
        ...
        <div className="relative hidden aspect-[0.463/1] h-[87.5%] rounded-[32px] sm:block">
          <div className="h-[4.4%] w-full bg-pink-300" />
          <div
            id="noScroll"
            className="absolute left-1/2 z-20 h-[95.6%] w-full -translate-x-1/2 overflow-y-scroll bg-black"
          >
            <Device />
          </div>
        </div>
